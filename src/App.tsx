            ...
            <section id="components" className=" pb-0">
                <div className="container">
                    <div className='divContainVid'>
                        <video src="https://ipfs.io/ipfs/QmcFPLWx3mJvmVsRNwgaDNhEMKzoKMWHHarV6macNrK1tZ?filename=EBI.mp4" poster="https://d2ybmb80bbm9ts.cloudfront.net/35/pj/QmVbsF1huHaf22Fgq6sBn6hiqMWAkqCF2GNRVwKFH835pj/nft.jpg" className="videoNFT">Video tag not supported</video>
